...
This guide will walk you through **practical labs**, **essential concepts**, and **insightful explanations** to help you build a strong foundation in RTL design.
...
A **simulator** is a software tool that checks your digital circuit’s functionality by applying test inputs and viewing outputs.
This helps you verify your design **before hardware implementation**.
...
* The simulator produces a ``** file** for waveform viewing in **GTKWave**.
...
/* Multiplexer logic: Select between i0 and i1 based on sel */
always @ (*)
begin
    if(sel)
        y <= i1;  // If sel=1, output i1
    else
        y <= i0;  // If sel=0, output i0
end
endmodule
```
...
It takes your Verilog code and converts it into a **gate-level netlist** — a hardware blueprint.
...
2. Read the liberty library:
   ...
   ```bash
   read_liberty -lib /path/to/libs/sky130_fd_sc_hd__tt_025C_1v80.lib
   ```
...
5. Technology mapping:
   ...
   ```bash
   abc -liberty /path/to/libs/sky130_fd_sc_hd__tt_025C_1v80.lib
   ```
